    ...
    <div>
        <div>
            ...
            <section class="business-one type{{Session::get('type')}}  hidden ">
                <h2>Crear Cliente</h2>
                <div>
                    {{ Form::open(array('name'=>'form-show-business','rotute' => 'business','files'=>true, 'method' => 'POST')) }}
            ...
            <section class="business-two type-tow{{Session::get('type')}} hidden">
                ...
                <div>
                    {{ Form::open(array('name'=>'form-show-business-two','rotute' => 'business','files'=>true, 'method' => 'POST')) }}
                        ...
                        <table class=" ">
                            ...
                            @foreach($business as $businessClient)
                                ...
                                <tr>
                                    ...
                                    <td>{{$businessClient->manager}}</td>
                                    <td>{{$businessClient->page_web}}</td>
                                    <td>{{$businessClient->source}}</td>
                                    <td>{{$businessClient->country}}</td>
                                    <td>{{$businessClient->city}}</td>
                                    <td>{{$businessClient->skype}}</td>
                                </tr>
                                @endif
                            @endforeach
                            </tbody>
