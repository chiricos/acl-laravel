...
@section('titleContent')
    <h1>Productos de Cotizacion</h1>
@stop

@section('content')
    <a href="{{route('addProducts',$business->id)}}" class="icon-reply back"></a>
    <div class="formContent">
        {{ Form::open(array('name'=>'form-update-permission','to' => 'admin/actualizarProducto/'.$stateProduct->id, 'method' => 'POST')) }}

        <div>
            {{Form::label('product_id','Producto:')}}
            {{ Form::select('product_id',$products,$stateProduct->product_id) }}
        </div>
        ...
        <div>
            ...
            {{ Form::text('quantity',$stateProduct->quantity) }}
        </div>
        ...
        <div>
            ...
            {{ Form::text('value',$stateProduct->value) }}
        </div>
